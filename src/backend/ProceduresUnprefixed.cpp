...
ProcArray CPU::getUnprefProcArray() {
    return {
        ...
        [this] /*0x46*/ { ld(B_, fetch8(HL_)); return false; },
        ...
        [this] /*0x4E*/ { ld(C_, fetch8(HL_)); return false; },
        ...
        [this] /*0x56*/ { ld(D_, fetch8(HL_)); return false; },
        ...
        [this] /*0x5E*/ { ld(E_, fetch8(HL_)); return false; },
        ...
        [this] /*0x66*/ { ld(H_, fetch8(HL_)); return false; },
        ...
        [this] /*0x6E*/ { ld(L_, fetch8(HL_)); return false; },
        ...
        [this] /*0x7E*/ { ld(A_, fetch8(HL_)); return false; },
